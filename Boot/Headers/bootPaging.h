...
extern void mapPage(uint64 phys, uint64 virt, bool w, bool u, bool nx);
extern void mapPages(uint64 phys, uint64 virt, uint32 pages, bool w, bool u, bool nx);
extern void setCR3();
extern void dumpPMAP(bool efi);
