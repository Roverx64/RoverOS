...
/*I do know Linux distros have an elf.h header*/

#define ELF_MAGIC "\177ELF"

//RoverOS specific macros
#define VTOP(phys,virt,vload) ((uintptr)phys+((uintptr)virt-(uintptr)vload))

//ELF structures
typedef struct ELF64eidentS{
    ELF64_Byte magic[4];
    ELF64_Byte class;
    ELF64_Byte data;
    ELF64_Byte version;
